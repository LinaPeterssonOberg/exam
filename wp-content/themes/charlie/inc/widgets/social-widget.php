...
class Social_Links_Widget extends WP_Widget {
    ...
    public function __construct(){
        ...
        // Base ID of your widget
            ...
            __( 'Social Widget', 'cha' ),

            // Widget description
            array( 'description' => __( 'Widget that shows a general information of the company and a icon or image', 'cha' ) )
        );
    }
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'featured image' ); ?>"><?php _e( 'Featured Image', 'cha' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'social-url' ); ?>"><?php _e( 'Social url:', 'cha' ); ?></label>
