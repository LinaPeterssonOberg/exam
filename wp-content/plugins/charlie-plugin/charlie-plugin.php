...
class Customers_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct( 'customers-widget',
            __('Customers Widget', 'cha')
        );
    ...
    public function widget ($args, $instance ) {
        ...
        <?php if ( ! empty( $instance['customer_logo'] ) ) : ?>
            ...
            <li>
                <img src="<?php echo esc_url( $instance['customer_logo'] ); ?>" alt="<?php if ( ! empty( $instance['title']) ) echo $instance['title']; ?>">
            </li>
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php echo __('Title', 'cha' ); ?></label>
        ...
        <p>
            <label for"<?php echo $this->get_field_id( 'customer_logo' ); ?>"><?php _e( 'Logo', 'cha' ); ?></label>
...
function cha_load_widget() {
    register_widget( 'customers_widget' );
}
add_action( 'widgets_init', 'cha_load_widget' );